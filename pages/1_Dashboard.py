...
ax3.axvline(x=0.75, color='red', linestyle='--', label='Ngưỡng Cao (0.75)')
ax3.axvline(x=0.55, color='orange', linestyle='--', label='Ngưỡng TB (0.55)')
ax3.set_xlabel('Final Score')
ax3.set_ylabel('Số sinh viên')
ax3.set_title('Phân bố Final Score = 0.7 × p_fail + 0.3 × ahp_score')
ax3.legend()
plt.tight_layout()
st.pyplot(fig3)
plt.close(fig3)
